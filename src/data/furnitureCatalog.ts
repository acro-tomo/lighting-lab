...
export const furnitureCatalog: FurniturePreset[] = [
  ...
  { id: "washstand", label: "洗面台", type: "washstand", name: "洗面台", size: { x: 0.75, y: 0.8, z: 0.5 }, color: "#f0f0ee", roughness: 0.45 },
  { id: "toilet", label: "トイレ", type: "toilet", name: "トイレ", size: { x: 0.4, y: 0.4, z: 0.6 }, color: "#f2f2f0", roughness: 0.35 },
