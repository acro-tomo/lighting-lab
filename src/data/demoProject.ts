  ...
  lights: [
    {
      ...
      name: "TV壁照射ダウンライト 1",
      type: "downlight",
      position: vec3(0.1, 2.38, -2.58),
      mountHeightM: 2.42,
      rotationDeg: { x: -62, y: 0, z: 0 },
      target: vec3(0.1, 1.15, -3.18),
      lumens: 520,
      ...
      penumbra: 0.35,
      castsShadow: true,
      note: "TV背面を弱く照らす壁ウォッシュ想定"
    },
    {
      id: "light-tv-wall-2",
      name: "TV壁照射ダウンライト 2",
      type: "downlight",
      position: vec3(1.1, 2.38, -2.58),
      mountHeightM: 2.42,
      rotationDeg: { x: -62, y: 0, z: 0 },
      target: vec3(1.1, 1.15, -3.18),
      lumens: 520,
      colorTemperatureK: 2700,
      dimmer: 70,
      enabled: true,
    ...
    },
    {
      ...
      name: "TV壁照射ダウンライト 3",
      type: "downlight",
      position: vec3(2.1, 2.38, -2.58),
      mountHeightM: 2.42,
      rotationDeg: { x: -62, y: 0, z: 0 },
      target: vec3(2.1, 1.15, -3.18),
      lumens: 520,
      colorTemperatureK: 2700,
      dimmer: 70,
      enabled: true,
    ...
    },
    {
      ...
      mountHeightM: 2.42,
      rotationDeg: { x: -70, y: 14, z: 0 },
      target: vec3(-3.0, 0.9, -0.55),
      lumens: 760,
    ...
    },
    {
      ...
      mountHeightM: 2.42,
      rotationDeg: { x: -72, y: 0, z: 0 },
      target: vec3(-3.0, 0.9, -0.35),
      lumens: 760,
      colorTemperatureK: 3500,
      dimmer: 82,
      enabled: true,
