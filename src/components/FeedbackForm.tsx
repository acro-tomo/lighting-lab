    ...
    <div className="feedback-widget" aria-label="フィードバック">
      {open && (
        <form className="feedback-body" onSubmit={submit}>
          ...
          <div className="feedback-types" role="radiogroup" aria-label="種別">
          ...
          <p className="feedback-note">
            内容は開発者の課題管理（GitHub）に送られます。個人情報や機密は書かないでください。
          </p>
        </form>
      )}
